            ...
            <div id="rev_slider_1078_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>
                    ...
                    <li data-index="rs-3045" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption medium_light_white tp-resizeme" id="slide-82-layer-3" data-blendmode=”color-dodge“ data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-10','-10','-10','-10']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"delay":500,"speed":1000,"sfx_effect":"blockfromleft","sfxcolor":"#ffffff","frame":"0","from":"z:0;","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" data-fontsize="['20','20','20','20']" data-lineheight="['34','34','34','50']">Explore our Tailored Traffic Management Solutions</div>
                ...
                <div class="col-12 col-lg-3 col-sm-6">
                    <div class="row align-items-start">
                        ...
                        <div class="col pl-0">
                            ...
                            <div class="text">
                                <a href="mailto:info@mycallup.com" class="link-light"><span class="__cf_email__"
                                        data-cfemail="d8b5b9b1b498b4b7bfa2bdbdf6bbb7b5">info@mycallup.com</span></a><br>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-5">
                    ...
                    <p>We provide a complete automation control for truck management and traffic flow in the busiest port
                        zones in Nigeria.</p>
                    <p>Our system allows for seamless movement from one terminal to another. Our system makes sure that
                        truck traffic doesn't obstruct other drivers, locals, or commercial establishments in the port
                        access lanes.</p>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-12 mb-0">
                    <h4 class="h4-xl">Interested in working with Mycallup?</h4>
                </div>
                <div class="col">
                    <div class="center-text">
                        You may always get in touch with us and follow our services on all of our social media channels.
                        Call or email us today with your questions.
                    </div>
                </div>
                <div class="col-sm-auto">
                    <a href="{{ url('/contact-us') }}" class="btn-theme bg-white light">Get In Touch <i
            ...
            <div class="row">
                <div class="col-lg-7 ms-lg-auto pos-rel col-md-12">
                    ...
                    <form class="form-inline tracking">
                        ...
                        <button type="submit" class="btn btn-theme bg-navy-blue mb-2 ml-3">Check Now <i
                ...
                <div class="col-lg-6 ms-auto">
                    ...
                    <div class="mt-5">
                        <ul class="nav nav-pills theme-tabbing mb-3" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-vision"
                                    role="tab" aria-controls="pills-profile" aria-selected="false">Vision</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="#pills-mission"
